...
public class TestCaseController {
    ...
    @Operation(summary = "테스트케이스 자동 생성", description = "여러 시나리오 ID를 기반으로 FastAPI에 테스트케이스 생성을 요청합니다.")
    @PostMapping("/generate")
    public ResponseEntity<?> generateTestCases(@RequestBody List<String> scenarioIds) {
        return testCaseService.delegateTestCaseGeneration(scenarioIds);
    }
